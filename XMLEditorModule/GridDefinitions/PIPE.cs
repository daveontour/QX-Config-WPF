...
namespace WXE.Internal.Tools.ConfigEditor.XMLEditorModule.GridDefinitions {
    ...
    public class PIPE : MyPropertyGrid {
        ...
        //[CategoryAttribute("Optional - Temporal Context Awareness"), DisplayName("Context Aware Pipe"), Browsable(true), PropertyOrder(1), DescriptionAttribute("XPath for the Context Key")]
        ...
        //        isBrowsable.SetValue(theDescriptorBrowsableAttribute, aware);
        ...
        //        if (value) {
        //            this.aware = true;
        //            SetAttribute("useMessageAsKey", false);
        //            SetAttribute("maxMsgPerMinute", -1);
        //             if (ContextExpiry <= 0) {
        //                ContextExpiry = 10;
        //            }
        ...
        [RefreshProperties(RefreshProperties.All)]
        [CategoryAttribute("Optional - Temporal Context Awareness"), DisplayName("Use Message As Key"), Browsable(true), PropertyOrder(1), DescriptionAttribute("Use a SHA256 hash of the entire message Isolate for the Context Cache Key (Duplicate Messages)")]
