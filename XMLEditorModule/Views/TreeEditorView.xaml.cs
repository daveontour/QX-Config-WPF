...
namespace QXEditorModule.Views {
    public partial class TreeEditorView : UserControl, INotifyPropertyChanged, IView {
        ...
        private void BindUIElementToViewModel() {
            ...
            contextMenuProvider.ContextMenus[ContextMenuType.AddSMTPOutput].Command = ViewModel.AddTypeOutputCommand;
            contextMenuProvider.ContextMenus[ContextMenuType.AddSMTPOutput].CommandParameter = "SMTP";
        ...
        private ContextMenu GetPipeContextMenu() {
            ...
            menuProvider.ContextMenus[ContextMenuType.AddSMTPOutput].Command = ViewModel.AddTypeOutputCommand;
            menuProvider.ContextMenus[ContextMenuType.AddSMTPOutput].CommandParameter = "SMTP";
        ...
        public void SMTPOut(XmlNode node) {
            viewModel.MyGrid = new SMTPOut(node, this);
            viewModel.OnPropertyChanged("myGrid");
        }
        ...
        public void TCPIN(XmlNode node) {
            viewModel.MyGrid = new TCPIN(node, this);
            viewModel.OnPropertyChanged("MyGrid");
        }
